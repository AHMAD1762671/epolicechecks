...
class Reception_model extends CI_model {
    ...
    public function login_reception($email, $password) {
    ...
    public function get_current_user_roles_permissions() {
        $user_role_id = $this->db->where('id', $this->session->userdata('reception_id'))->get('users')->row()->user_role_id;
...
//        var_dump($data); die();
    ...
    public function update_edit_digital_fingerprint_form_save() {
        $data = array(
            ...
            'consent_middle_name' => $this->input->post('consent_middle_name'),
            'consent_last_name' => $this->input->post('consent_last_name'),
            'consent_maiden_name' => $this->input->post('consent_maiden_name'),
            'consent_dob' => $this->input->post('consent_dob'),
            'consent_place_of_birth' => $this->input->post('consent_place_of_birth'),
            'consent_phone' => $this->input->post('consent_phone'),
            'consent_cellphone' => $this->input->post('consent_cellphone'),
            ...
            'address' => $this->input->post('address'),
            'rcmp_status' => $this->input->post('rcmp_status'),
            'dcb_number' => $this->input->post('dcb_number'),
            'edit_application' => $this->input->post('consent_comments'),

            'referred_by' => $this->input->post('referred_by'),
            'digital_fingerprinting_application_id' => $this->input->post('digital_fingerprinting_application_id'),
        );

        $this->db->where('digital_fingerprinting_application_id', $data['digital_fingerprinting_application_id']);
...
//            'card_expiry' => $this->input->post('card_expiry_month') . '/' . $this->input->post('card_expiry_year'),
    ...
    public function complete_digital_fingerprinting_application($application_id){
        $this->db->set('edit_application', 1); //value that used to update column
    ...
    public function record_suspension_form_save() {
        ...
        $data = array(
            ...
            'payment_status' => 0,
            'client_id' => $clinet_id,
            'agent_id' => $this->session->userdata('reception_id'),
...
//        $application_id = UUID();
        ...
        $data = array(
            'state_id' => $this->input->post('state_id'),
            'delivery_name' => $this->input->post('applicant_name'),
            ...
            'client_id' => $client_id,
            'reception_id' => $this->session->userdata('reception_id'),
//            'reception_id' => 'reception@gmail.com',
        );
...
//    }
    ...
    public function edit_reception_profile_save(){
        ...
        $this->db->where('id', $this->session->userdata('reception_id')); //which row want to upgrade
...
//    count the applicaitons for counter purposex
    public function count_namebase_app(){
        $this->db->where('reception_id', $this->session->userdata('reception_id'));
        $result = $this->db->get('name_based_applications')->num_rows();
        return $result;
    }
    public function count_digitalfingerprinting_app(){
        $this->db->where('reception_id', $this->session->userdata('reception_id'));
        $result = $this->db->get('digital_fingerprinting_applications')->num_rows();
        return $result;
    }
    public function count_record_suspension_app(){
        $this->db->where('reception_id', $this->session->userdata('reception_id'));
        $result = $this->db->get('record_suspension_applications')->num_rows();
        return $result;
    }
    public function count_usentry_app(){
//        $this->db->where('reception_id', $this->session->userdata('reception_id'));
        $result = $this->db->get('us_entry_waiver_applications')->num_rows();
        return $result;
    }
