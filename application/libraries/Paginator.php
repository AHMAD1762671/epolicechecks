...
class Paginator
{
    ...
    function get_links($resources_name='', $css_framework='bootstrap4')
    {
    ...
    {
        $per_page = isset($optional['per_page']) ? $optional['per_page'] : 20;
        ...
        Paginator::$options['start'] = ($limit*($offset-1))+1;
        ...
        if(is_object($resources) && property_exists($resources, 'dbdriver')){
            ...
            return $ci->db->get($resources, $limit, $limit*($offset-1))->result();
    ...
    function get_start_count(){
        return Paginator::$options['start'];
    }
