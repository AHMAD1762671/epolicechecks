    ...
    <div class="row">
        <div class="col-md-3 form-group mb-3">
            ...
            <select class="form-control" name="cars" id="cars">
                <option value="volvo">corporate@gmail.com</option>
                <option value="saab">corporate2@gmail.com</option>
                <option value="mercedes">sub_corporate@gmail.com</option>
                <option value="audi">corporate123@gmail.com</option>
            </select>
...
<!--            <div class="text-danger">--><?//= form_error('last_name'); ?><!--</div>-->
        ...
        <div class="col-md-3 form-group mb-3">
            ...
            <input type="date" class="form-control" required="" name="company_name" value="<?= set_value('last_name') ?>">
            <div class="text-danger"><?= form_error('last_name'); ?></div>
        </div>
