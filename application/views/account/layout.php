                    ...
                    <div class="dropdown">
                        <div class="user colalign-self-end">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown" id="showdata">
                                <a class="dropdown-item" href="<?= base_url('account/account') ?>">Account settings</a>
                                <a class="dropdown-item" href="<?= base_url('account/logout') ?>">Sign out</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="side-content-wrap">
                <div class="sidebar-left open" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                    <ul class="navigation-left">
                        ...
                        <li class="nav-item <?= active_menu('account/dashboard_pre') ?>">
                            <a class="nav-item-hold" href="<?= base_url('account/dashboard_pre') ?>">
                        ...
                        <li class="nav-item <?= active_menu('account/#') ?>">
                            <a class="nav-item-hold" href="<?= base_url('account/#') ?>">
                                <span class="nav-text"><span class="fas fa-file-invoice"></span> Corporate Invoices </span>
                            </a>
                            <div class="triangle"></div>
                        </li>
                        ...
                        <li class="nav-item <?= active_menu('account/#') ?>">
                            <a class="nav-item-hold" href="<?= base_url('account/#') ?>">
                                <span class="nav-text"><span class="fas fa-file-invoice"></span> Agent Invoices </span>
                            </a>
                            <div class="triangle"></div>
                        </li>
                        ...
                        <li class="nav-item <?= active_menu('account/#') ?>">
                            <a class="nav-item-hold" href="<?= base_url('account/#') ?>">
                                <span class="nav-text"><span class="fas fa-file-invoice"></span> User Invoices </span>
                            </a>
                            <div class="triangle"></div>
                        </li>

                        <li class="nav-item <?= active_menu('account/invoice_list_all') ?>">
                            <a class="nav-item-hold" href="<?= base_url('account/invoice_list_all') ?>">
                                <span class="nav-text"><span class="fas fa-file-invoice"></span> All Individual Invoices </span>
                            </a>
                            <div class="triangle"></div>
                        </li>
                        ...
                        <li class="nav-item <?= active_menu('portal/dashboard') ?>">
                            <a class="nav-item-hold" href="<?= base_url('account/report_dashboard') ?>">
                                <span class="nav-text"><span class="fa fa-chart-bar"></span> Reports</span>
                            </a>
                            <div class="triangle"></div>
                        </li>
...
<!--                                    <span class="nav-text"><span class="fa fa-globe"></span> Locations</span>-->
<!--                                </a>-->
<!--                                <div class="triangle"></div>-->
<!--                            </li>-->
<!--                            --><?php
...
//                        if (check_route('locations', 'get')):
//                            ?>
<!--                            <li class="nav-item --><?//= active_menu('portal/accounts') ?><!--">-->
...
<!--                        <li class="nav-item --><?//= active_menu('account/invoice') ?><!--">-->
<!--                            <a class="nav-item-hold" href="--><?//= base_url('account/invoice') ?><!--">-->
