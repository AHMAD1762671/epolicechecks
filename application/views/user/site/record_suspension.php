...
<!--                        <br />-->
                        <div class="form-group">
                            <b> Select your current residence: <span class="required_class"> </span> </b>
...
<!--                </div><br>-->
                ...
                <a href="<?php echo base_url('user/app_record_suspension_consent/1/1'); ?>">
                    <button class="btn btn-primary pull-right next_button_custom_css mobile_setting_next_button"  type="button">Next</button>
                </a>
