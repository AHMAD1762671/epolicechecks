...
<div class="container">
    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step col-xs-3">
                <a href="#step-5" type="button" class="btn btn-default btn-circle" data-placement="top" disabled="disabled" title="Declaration of Criminal Record">8</a>
                <!--                <p><small>Declaration of Criminal Record</small></p>-->
            </div>

            <div class="stepwizard-step col-xs-3" data-toggle="tooltip" data-placement="top" title="Record Suspension Signature">
                <a href="#step-1" type="button" class="btn btn-success btn-circle">9</a>
            </div>
    ...
    <form role="form" method="post" action="#">
        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Record Suspension Signature</h3>
            </div>
