...
<section style="background:#efefe9;">
    <div class="row">
        ...
        <form action="<?= base_url() ?>agent/application/record-suspension" method="post">
            <div class="board">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="step1">
                        ...
                        <br />
                            ...
                            <button type="button" class="btn btn-success" style="width: 139px; margin-left: 55px;">Next</button>
