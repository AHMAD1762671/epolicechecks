...
<div class="container">
    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step col-xs-3" data-toggle="tooltip" data-placement="top" title="U.S. Entry Waiver Signature">
    ...
    <form role="form" method="post" action="#">
        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">U.S. Entry Waiver Signature</h3>
            </div>
