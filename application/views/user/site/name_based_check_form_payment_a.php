    ...
    <FORM METHOD="POST" ACTION= https://www3.moneris.com/HPPDP/index.php >
        ...
        <div class="panel panel-primary setup-content" id="step-4">
            ...
            <div class="panel-body gray_background margin-top-adjustment">
                ...
                <div class="row" style="margin-bottom: 10px; width: 111%;">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-1"">
                        ...
                        <a href="<?php echo base_url('user/app_name_based_check_form'); ?>">
                            <button style="width: 125%;" class="btn btn-success nextBtn pull-right next_button_custom_css mobile_setting_next_button" type="button">Back</button>
                        </a>
...
<!--                        <a href="--><?php //echo base_url('user/app_name_based_check_consent/1/1'); ?><!--">-->
<!--                            <button style="width: 125%;" class="btn btn-primary nextBtn pull-right next_button_custom_css mobile_setting_next_button" type="button">Pay Now</button>-->
<!--                        </a>-->



                        <!--                                        for moneris gateway fields(hidden)-->
                        <!--                                        for moneris gateway fields(hidden)-->
                        <!--                                        for moneris gateway fields(hidden)-->
<!--                        <INPUT TYPE="HIDDEN" NAME="ps_store_id" VALUE="H3ZY219448">-->
<!--                        <INPUT TYPE="HIDDEN" NAME="hpp_key" VALUE="hpO9MV8XG8H5">-->

                        <INPUT TYPE="HIDDEN" NAME="ps_store_id" VALUE="E9NQP19448">
                        <INPUT TYPE="HIDDEN" NAME="hpp_key" VALUE="hpEROKBVI97C">

                        <INPUT TYPE="HIDDEN" NAME="charge_total" VALUE="0.01">
                        ...
                        <INPUT TYPE="HIDDEN" NAME="idn" VALUE="<?php echo base_url('user/namebasedcheck/123') ?>">
                        <INPUT TYPE="HIDDEN" NAME="quantityn" VALUE="1">
                        <INPUT TYPE="HIDDEN" NAME="gst" VALUE="0">
                        <INPUT TYPE="HIDDEN" NAME="hst" VALUE="0">
                        <INPUT TYPE="HIDDEN" NAME="pricen" VALUE="0.1">
                        <INPUT TYPE="HIDDEN" NAME="subtotaln" VALUE="0.1">
...
<!---->
<!--                <a href="--><?php //echo base_url('user/app_name_based_check_form'); ?><!--">-->
<!--                    <button class="btn btn-success nextBtn pull-right next_button_custom_css mobile_setting_next_button" type="button">Back</button>-->
<!--                </a>-->
