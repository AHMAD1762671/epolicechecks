...
<div class="container">
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            <div class="stepwizard-step col-xs-3" data-toggle="tooltip" data-placement="top" title="Select one of the following!">
                <a href="#step-3" type="button" class="btn btn-success btn-circle" disabled="disabled">1</a>
            </div>
    ...
    <form role="form">
        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped bg-success active" role="progressbar" style="width: 95%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
