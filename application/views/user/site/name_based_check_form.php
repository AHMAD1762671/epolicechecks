            ...
            <div class="panel-body gray_background margin-top-adjustment">
                ...
                <div class="row" style="margin-bottom: 70px;">
                    ...
                    <div class="col-sm-4 text-dark bg-white text-center abc " style=" border: 1px solid #d1d4db; border-bottom: 4px solid #c1d72f;">
                        <input type="radio" name="canada" class="form-control input" style="width: 10%; text-align: center; margin-left: 46%;" required>
                        <br/>
...
<!--                        <br/>-->
                ...
                <button class="btn btn-primary nextBtn pull-right next_button_custom_css mobile_setting_next_button" onclick="myFunction()" type="button">Next</button>
                                ...
                                <div id="collapse0" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="heading0" data-parent="#accordion">
                                    ...
                                    <div class="panel-body px-3 mb-4">
                                        ...
                                        <?php foreach ($sub_services as $key => $value) { ?>
                                            <div class="container">
                                                <div class="row mobile_visibility" >
                                                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12" style="">
                                                        <input type="checkbox" class="services_prices" name="services[]" value="<?= $value->subservice_id ?>" id="foo_bar">



                                                        <input type="hidden" name="services_prices[<?= $value->subservice_id ?>]" value="<?= get_subservice_price($value->subservice_id) ?>">
                                                        <label for="foo_bar"><?= $value->subservice_name ?>:</label>
                                                    </div>
                                ...
                                <div class="panel-heading p-3 mb-3" role="tab" id="heading1">
                                    <h3 class="panel-title">
                                        <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="false" aria-controls="collapse1">
                                            <!---->
                                            I want my original result to be delivered at:
                                        </a>
                                    </h3>
                                </div>
                                    ...
                                    <div class="panel-body px-3 mb-4">
                                        ...
                                        <div class="row margin-adjustment">
                                            <div class="col-lg-12" >
                                                ...
                                                <div class="form-group">
                                                    <label for="inputdefault">Applicant Name / Company Name / Third Party Name: <span class="required_class"> </span> </label>
                                                    <input class="form-control" id="inputdefault" required name="delivery_name" value="zain ul abaidin" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputdefault">Address:<span class="required_class"> </span></label>
                                                    <input class="form-control" id="inputdefault" required="" value="House no. 15, Street no. 02, Zaman park sanda kalan Lahore" name="delivery_address" type="text">
                                                </div>
                                                <div class="row">
                                                    <!--CITY-->
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label for="inputdefault">City:<span class="required_class"> </span></label>
                                                            <input class="form-control" id="inputdefault" required="" value="Lahore" name="delivery_city" type="text">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="inputdefault">Province:<span class="required_class"> </span></label>
                                                            <input class="form-control" id="inputdefault" required="" value="Punjab" name="delivery_state" type="text">
                                                        </div>
                                                    </div>
                                                    <!--Province-->
                                                    <!--Country-->
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="inputdefault">Country:<span class="required_class"> </span></label>
                                                            <input class="form-control" id="inputdefault" required="" value="canada" name="delivery_country" type="text">
                                                        </div>
                                                    </div>
                                                    <!--Country-->
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label for="inputdefault">Tel:<span class="required_class"> </span></label>
                                                            <input class="form-control" id="inputdefault" required="" value="03246337362" name="delivery_phone" type="text">
                                                        </div>
                                                    </div>
                                                    <!--Tel-->
                                                    <!--Email-->
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="inputdefault">Email:<span class="required_class"> </span></label>
                                                            <input class="form-control" id="inputdefault" type="text" value="zainulabaidinz@gmail.com" required="" name="delivery_email">
                                                        </div>
                                                    </div>
                                                    <!--Email-->
                                ...
                                <div class="panel-heading p-3 mb-3" role="tab" id="heading2">
                                    <h3 class="panel-title">
                                        <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="true" aria-controls="collapse2">
                                            Please select one method of delivery
                                        </a>
                                    </h3>
                                </div>
...
<!--                                                    <strong><span id="total_sub">0</span> CAD</strong>-->
                                                    <input type="text" name="coupon" class="form-control coupon-field" placeholder="Enter Coupon code">
...
<!--                    <div class="stepwizard-row setup-panel">-->
<!--                        <div class="stepwizard-step col-xs-3">-->
<!--                            <a href="#step-1" type="" class="">-->
<!--                                <button class="btn btn-success  pull-right next_button_custom_css mobile_setting_next_button"  type="button">Back</button>-->
<!--                            </a>-->
<!--                        </div>-->
<!--                    </div>-->
                ...
                <a href="<?php echo base_url('user/app_name_based_payment_aqua'); ?>">
