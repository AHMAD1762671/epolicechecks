    ...
    foreach ($applications as $key => $value) { ?>
            ...
            <li data-toggle="modal" style="list-style:none;" data-target="#forward_application_to_user">
                ...
                <a href="#">
                    ...
                    <h3 style="font-size: 16px;">Application # <?= $value->name_based_application_id ?></h3>
                    <hr/>
                    <p><b>Name Based Check Applications</b></p>
                    ...
                    <div class="modal-body p-0" style="overflow-y: hidden;">
                        <fieldset  class="show" id="tab011">
                            ...
                            <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                <div class="col-md-12">
                                    <h3 style="text-align: center;">Name Based Application</h3>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p class="card-text"> <b>Application #</b> <?= $value->name_based_application_id ?></p>
