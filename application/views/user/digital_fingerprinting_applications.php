    ...
    foreach ($applications as $key => $value) { ?>
            ...
            <li data-toggle="modal" style="list-style:none;" data-target="#forward_application_to_user">
                ...
                <a href="#">
                    ...
                    <h3 style="font-size: 16px;">Application # <?= $value->digital_fingerprinting_application_id ?></h3>
                    <hr/>
                    <p><b>Digital Fingerprinting Applications</b></p>
                    ...
                    <div class="modal-body p-0" style="overflow-y: hidden;">
                        <fieldset  class="show" id="tab011">
                            ...
                            <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                <div class="col-md-12">
                                    <h3 style="text-align: center;">Digital Fingerprinting Application</h3>
                                </div>
                            </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p class="card-text"> <b>Application #</b> <?= $value->digital_fingerprinting_application_id ?></p>
                                    <p class="card-text"> <b>Gender:</b> <?= $value->gender ?> </p>
                                    ...
                                    <?php foreach ($comments as $valuee) { ?>
                                        <li class="media border-top pt-3">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p> <img src="<?php echo base_url('assets/pdf223.jpg') ?>" height="50" width="70"></p>
                                        </li>
                                    <?php } ?>
                                </div>
                            </div>
