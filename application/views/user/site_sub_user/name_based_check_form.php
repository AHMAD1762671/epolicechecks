...
<section style="background:#efefe9;">
    <div class="row">
        ...
        <form action="<?= base_url() ?>user/application/name-based-check-sub-user" method="post">
            <div class="board">
...
<!--                                        <input type="radio" data-price="--><?php //echo $value->delivery_method_price ?><!--" id="delivery---><?php //echo $value->delivery_method_id ?><!--" required="" value="--><?php //echo $value->delivery_method_id ?><!--" name="delivery_method" class="delivery_method">-->
<!--                                        <label for="delivery---><?php //echo $value->delivery_method_id ?><!--">--><?php //echo $value->delivery_method_name ?><!--</label>-->
<!--                                    </div>-->
<!--                                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 text-left">-->
<!--                                        <strong><span>--><?php //echo $value->delivery_method_price ?><!--</span> CAD</strong>-->
<!--                                    </div>-->
<!---->
<!--                                </div> -->
<!--                                <br />-->
