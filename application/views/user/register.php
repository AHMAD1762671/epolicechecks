...
<!--                                </svg>-->
                        ...
                        <input required  class="form-control" name="fname" type="text" placeholder="First Name">
                    </div>
                </div>
                    ...
                    <div class="col-6 d-flex align-items-center">
                        ...
                        <div class="custom-control">
                            <a href="<?php echo base_url().'user'; ?>">
                                <label class="custom-control-label" for="cb1">Login / SignIn</label>
                            </a>
                        </div>
                ...
                <div class="row mt-6 mb-6">
                    ...
                    <button class="btn btn-primary btn-block" style="background-color: #0F3C78;">Register</button>
