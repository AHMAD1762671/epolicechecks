...
<div class="forny-container">
    ...
    <div class="forny-inner">
        ...
        <div class="forny-form">
            ...
            <form method="post" action="<?= base_url('user/reset_password_save') ?>">
                ...
                <div class="form-group password-field">
                    <div class="input-group">
                        ...
                        <input required  class="form-control" name="cpassword" type="password" placeholder="Retype Password">
...
<!--                        </div>-->
                    ...
                    <div class="col-6 text-right">
                        <a href="<?php echo base_url().'user/forgot-password'; ?>">Login</a>
                    </div>
                </div>
                ...
                <div class="row mt-6 mb-6">
                    ...
                    <div class="col-12 d-flex align-items-center">
                        <button class="btn btn-primary btn-block" style="background-color: #0F3C78;">Reset Password</button>
                    </div>
