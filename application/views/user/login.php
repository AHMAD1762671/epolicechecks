...
<head>
    ...
    <style>
        @media only screen and (min-width: 850px) and (max-width: 1024px)  {
            .forny-container {
/*                background: url('*/<?php //echo base_url().'/assets/images/map2.1_new.jpg'; ?>/*')  center center no-repeat;*/
/*                background: url('*/<?php //echo base_url().'/assets/images/map2_new.jpg'; ?>/*')  center center no-repeat;*/
                background: url('<?php echo base_url().'/assets/images/map2.jpg'; ?>')  center center no-repeat;
            }
        }
        @media only screen and (min-width: 768px) and (max-width: 849px)  {
            .forny-container {
                background: url('<?php echo base_url().'/assets/images/map-ipad.jpg'; ?>')  center center no-repeat;
            }
        }
        @media (min-width: 1025px) {
            .forny-container {
                background: url('<?php echo base_url().'/assets/images/map2.1_blur.jpg'; ?>')  center center no-repeat;
/*                background: url('*/<?php //echo base_url().'/assets/images/map2_new.jpg'; ?>/*')  center center no-repeat;*/
/*                background: url('*/<?php //echo base_url().'/assets/images/map1.jpg'; ?>/*') center center no-repeat;*/
            }
        }
        @media screen and (min-width: 1900px) {
            .forny-container {
                background: url('<?php echo base_url().'/assets/images/map_32_inch_screen.jpg'; ?>') center center no-repeat;
            }
        }
...
<!--                <p class="mb-10">Use your credentials to access your account.</p>-->
            ...
            <form method="post" action="<?= base_url('user/signin') ?>">
                ...
                <div class="row mt-6 mb-6">
                    <div class="col-6 d-flex align-items-center">
                        <input style="background-color: #0F3C78;" class="btn btn-primary btn-block" onclick="window.location.href='<?php echo base_url().'user/register' ?>'" type="button" value="Register">
                    </div>
