<h1>Successfully (site controller) </h1>

<?php
echo "response_order_id ". "response_order_id ". $response_order_id = $this->input->post('response_order_id') . "<br>";
...
echo $is_visa_debit = $this->input->post('is_visa_debit') . "<br>";
?>
