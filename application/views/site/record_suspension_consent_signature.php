                        ...
                        <div class="tab-content">
                            <div id="home" class="tab-pane fade in active" style="margin-bottom: 50px;">
                                <div class="row" style="padding-left: 15px; padding-right: 15px; background-color: #e0eeee; margin-right: 15px; margin-left: 15px;">
                                    <form action="<?php echo base_url() ?>site/save_record_suspension_consent_text_signature" method="post">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="step1" style="">
                                                    <div class="row" style="margin-right: 15px;">
                                                        ...
                                                        <form id="signatureform" action="<?php echo base_url() ?>site/save_record_suspension_consent_drawable_signature" enctype="multipart/form-data" style="display:none" method="post">
                            ...
                            <div id="menu2" class="tab-pane fade" style="margin-bottom: 50px;">
                                <form action="<?php echo base_url() ?>site/save_record_suspension_consent_picture_signature" method="post" enctype="multipart/form-data">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
