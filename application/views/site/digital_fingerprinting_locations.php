...
<form action="<?= base_url() ?>digital-fingerprinting/canada" method="post">
    <div class="row" style="margin-bottom: 20px;">
        ...
        <div class="col-sm-7" align="right">
            ...
            <a type="button" href="<?= base_url() ?>digital-fingerprinting/canada" class="btn btn-success border mt-4"  style="width: 170px; ">< Back </a>
...
<script>
    ...
    $('#cities').on('change', function () {
        ...
        $.post('<?= base_url() ?>get-agent-locations',
