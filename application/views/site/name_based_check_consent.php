...
<body>
    <section style="background:#efefe9;">
        <div class="container">
            <form action="<?= base_url() ?>name-based-check/consent" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="board">
...
<!--                                </div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required="" type="text" placeholder="Enter Your Last Name"  name="consent_last_name"class="form-control input"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-pencil"></i> </span>
                                            <input required="" type="text" placeholder="Enter Your First Name" name="consent_first_name"class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-pencil"></i> </span>
                                            <input type="text" name="consent_middle_name" placeholder="Enter Your Middle Name" class="form-control input"/>
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-pencil"></i> </span>
                                            <input type="text" name="consent_nickname" placeholder="Enter Your Maiden/Alias/Nickname" class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding-top: 25px;">
                                            <label> Gender:  &nbsp; &nbsp; </label>
                                            <label> <input required="" type="radio" value="Male" required="" name="consent_gender"/>  Male </label> &nbsp; &nbsp;
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <input required="" type="date" placeholder="Enter Your Date of Birth" name="consent_dob" class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <input required="" type="text" name="consent_birth_place" placeholder="Enter Your Place of Birth" placeholder="City/Town, Province/State" class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <label> Country: </label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4  col-md-4  col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required="" type="number" placeholder="Enter Your Telephone" name="consent_phone" class="form-control input"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <label>Cell:</label>
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="consent_cellphone" placeholder="Enter Your Cell" class="form-control input"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <label>Email:</label>
                                            <div class="input-group">
                                                ...
                                                <input required="" type="email" placeholder="Enter Your Email" name="consent_email" class="form-control input"/>
                                            </div>
                                        </div>
                                    </div><br />
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-envelope"></i> </span>
                                            <input required="" type="text" placeholder="Enter Your Current address" name="consent_current_address" class="form-control input"/>
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-location"></i> </span>
                                            <input required="" type="text" placeholder="Enter Your City" name="consent_current_city" class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-location"></i> </span>
                                            <input required="" type="text" placeholder="Enter Your Province" name="consent_current_state" class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <input required="" type="text" placeholder="Enter Your Postal Code" name="consent_current_post_code" class="form-control input"/>
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <input type="text" placeholder="Enter Your Previous Address" name="consent_previous_address" class="form-control input"/>
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-map-pin"></i> </span>
                                            <input type="text" name="consent_previous_city" placeholder="Enter Your City" class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <label>Province:</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-map-pin"></i> </span>
                                            <input type="text" name="consent_previous_state" placeholder="Enter Your Province" class="form-control input"/>
                                                </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <label>Postal Code:</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fas fa-map-pin"></i> </span>
                                            <input type="text" name="consent_previous_post_code" placeholder="Enter Your Postal Code" class="form-control input"/>
                                                </div>
                                        </div>
                                    </div> <br/>
...
<!--                                here is the tabbed code ends-->
                                ...
                                <div class="row" style="margin-bottom: 15px; margin-right: 5px;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="right">
                                        ...
                                        <button type="submit" class="btn btn-success" id="submit-button">Next</button>
                                    </div>
                                </div>
                            </div>
