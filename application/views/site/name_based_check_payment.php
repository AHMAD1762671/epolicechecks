...
<body>
    ...
    <div class="container" style="background-color: #ffffff;">
        ...
        <br/>
        <form action="<?= base_url() ?>name-based-check/payment" method="post" class="form-horizontal">
<!--        <FORM METHOD="POST" ACTION= https://www3.moneris.com/HPPDP/index.php  >-->
            <div class="row" style="text-align: center; background-color: #d1cdcd;">
...
<!--                                        <input type="text" required="" class="form-control"  placeholder="Please Enter Card Number" name="card_number_1" >-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                            <div class="form-group row">-->
...
<!--                                        <input type="text" required="" placeholder="Please Enter Card Expiry" class="form-control" name="card_expiry">-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                            <div class="form-group row">-->
...
<!--                                        <input type="text" name="card_holder_name" placeholder="Please Enter Card Holder Name" id="cardholdername" required="" class="form-control input"/>-->
<!--                                    </div>-->
...
<!--                                        <input type="text" name="card_cvc" id="cvc" placeholder="Please Enter CVV2/CVC2 Code" class="form-control input" required="" class="form-control input"/>-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                            <!--<div class="row" style="color: gray; margin-left: 1px;"> as specified/indicated in the card </div>-->-->
...
<!--                </div>-->
            ...
            <INPUT TYPE="HIDDEN" NAME="charge_total" VALUE=<?= $grand_total ?>>
            <INPUT TYPE="HIDDEN" NAME="order_id" VALUE="1158">
            <INPUT TYPE="HIDDEN" NAME="bill_company_name" VALUE="GAC">
            <input type="hidden" name="cust_id" VALUE=<?= $client_id ?>
            <INPUT TYPE="HIDDEN" NAME="descriptionn" VALUE="Hellow Description">
            <INPUT TYPE="HIDDEN" NAME="quantity" VALUE="1">
            <INPUT TYPE="HIDDEN" NAME="email" VALUE="client@email.com">
            ...
            <INPUT TYPE="HIDDEN" NAME="pricen" VALUE=<?= $grand_total ?>>
            <INPUT TYPE="HIDDEN" NAME="subtotaln" VALUE=<?= $grand_total ?>>
...
<!--                        <input type="text" name="card_holder_email"  placeholder="Please Enter Email" required="" class="form-control input"/>-->
<!--                    </div>-->
<!--                    <br/>-->
<!--                    <div class="input-group">-->
<!--                        <span class="input-group-addon"><i class="fa fa-phone"></i> </span>-->
<!--                        <input type="text" name="card_holder_phone" placeholder="Please Enter Telephone" required="" class="form-control input"/>-->
<!--                    </div>-->
<!---->
<!---->
<!--                </div>-->
...
<!--            </div>-->
            ...
            <div class="custom-control custom-checkbox mb-3">
                ...
                <i>I have read and understood this declaration and
                        disclaimer <b style="color: #ca2d1e;"> * </b> </i>
                </label>
            </div> <br />

            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
                <button class="btn btn-success" type="submit" style="width: 28% !important;"> Submit </button>
<!--                <INPUT TYPE="SUBMIT" NAME="SUBMIT" VALUE="Click to proceed to Secure Page">-->
            </div>
