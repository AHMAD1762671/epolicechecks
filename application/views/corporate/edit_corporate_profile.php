...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <form action="<?= base_url('corporate/edit_corporate_profile_save') ?>" method="post">
...
<!--            </div>-->
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 form-group mb-3">
                        <label>Company</label>
                        <input type="text" class="form-control" required="" name="company" value="<?= $edit_agent_data['company'] ?>">
...
<!--                        <input type="file" class="form-control" name="profilePicture" value="--><?//= $edit_agent_data['profilePicture'] ?><!--">-->
<!--                        <div class="text-danger">--><?//= form_error('profilePicture'); ?><!--</div>-->
<!--                    </div>-->
    ...
    $(document).ready(function(){
        ...
        $('.crop_image').click(function(event){
            $image_crop.croppie('result', {
                ...
                $.ajax({
                    url:"<?php echo base_url('corporate/upload_profile_img') ?>",
                    type: "POST",
                    data:{"image": response},
