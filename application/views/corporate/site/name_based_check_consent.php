...
<body>
    ...
    <section style="background:#efefe9;">
        <div class="container">
            <form action="<?= base_url() ?>corporate/application/name-based-check/consent" method="post">
                <div class="row">
                    <div class="board">
                                ...
                                <div class="row"  style="padding-left: 15px; padding-right: 15px; background-color: #e0eeee; margin-right: 15px; margin-left: 15px;">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        ...
                                        <p style="color: black;  text-align:justify;" >	and to me. I hereby
                                            release and forever discharge the Police service board, police service and all their corporates, officers and
