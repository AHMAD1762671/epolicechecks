...
<body>
    ...
    <section style="background:#efefe9;">
        <div class="container">
            <form action="<?= base_url() ?>corporate/application/us-entry-waiver/consent" method="post">
                <div class="row">
                    <div class="board">
                            ...
                            <div class="tab-pane fade" id="step3">
                                ...
                                <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <p style="color: black;">
                                            If yes, when (DD-MM-YYYY)  <input type="date" name="consent_refused_border_date" class="form-control input"/>
                                        </p>
                                        <p style="color: black;">	
                                            ...
                                            <input type="radio" required="" value="No" name="consent_deported_america"/>  &nbsp; &nbsp;
                                        </p>
                                        <p style="color: black;">
                                            If yes, when (DD-MM-YYYY) <input  type="date" name="consent_deported_america_date" class="form-control input"/>
                                        </p>
                                        <p style="color: black;">	
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <table  width="100%" style="margin-top: 5px;">
                                            <tr id="heading">
                                                ...
                                                <th id="mid">Date of Sentence(YYYY/MM/DD)</th>
