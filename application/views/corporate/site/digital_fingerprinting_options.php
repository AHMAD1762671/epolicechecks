...
<form action="<?= base_url() ?>corporate/application/digital-fingerprinting/canada" method="post" id="form-options">
    <div class="row" style="margin-bottom: 20px;">
        ...
        <div class="col-sm-7" align="right">
            ...
            <a type="button" href="<?= base_url() ?>corporate/application/digital-fingerprinting" class="btn btn-success border mt-4"  style="width: 170px; ">< Back </a>
