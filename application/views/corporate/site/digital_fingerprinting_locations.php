...
<form action="<?= base_url() ?>corporate/application/digital-fingerprinting/canada" method="post">
    <div class="row" style="margin-bottom: 20px;">
        ...
        <div class="col-sm-7" align="right">
            ...
            <a type="button" href="<?= base_url() ?>corporate/application/digital-fingerprinting/canada" class="btn btn-success border mt-4"  style="width: 170px; ">< Back </a>
...
<script>
    $('#states').on('change', function () {
        ...
        $.post('<?= base_url() ?>corporate/application/get-city-by-state',
                {state_id: state_id},
                function (data) {
                    $('#cities').html(data);
                });
    ...
    $('#cities').on('change', function () {
        ...
        $.post('<?= base_url() ?>corporate/get-agent-locations',
