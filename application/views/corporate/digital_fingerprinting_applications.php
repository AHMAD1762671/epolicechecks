            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #4a85fb 0, #163eaf 100%); box-shadow: 0 2px 10px rgb(22 62 175 / 30%);}">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b>0</b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    foreach ($applications as $key => $value) {
                        ?>
                        <tr>
                            <th class="align-middle"><?= $value->digital_fingerprinting_application_id ?></th>
                            <th class="align-middle"><?= $value->consent_last_name ?></th>
                            <th class="align-middle"><?= $value->consent_first_name ?></th>
                            <th class="align-middle"><?= $value->consent_dob ?></th>
                            <th class="align-middle"><?= $value->consent_phone ?></th>
                            <td class="align-middle"><?= $value->application_status ?> CAD</td>
                            <td class="align-middle"><?= get_admin_email_by_id($value->corporate_id) ?></td>
