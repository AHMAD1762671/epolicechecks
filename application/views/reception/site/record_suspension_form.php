...
<div class="container">
    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step col-xs-3">
                <a href="#step-0" type="button" class="btn btn-default btn-circle" disabled="disabled">3</a>
                <!--                <p><small>Cargo</small></p>-->
            </div>
            ...
            <div class="stepwizard-step col-xs-3" data-toggle="tooltip">
                <a href="#step-2" type="button" class="btn btn-default btn-circle"  data-placement="top"  title="Address" disabled="disabled">5</a>
                <!--                <p><small>Address</small></p>-->
            </div>
            <div class="stepwizard-step col-xs-3">
                <!--                <a href="#step-3" type="button" class="btn btn-default btn-circle" disabled="disabled" title="Reason for Request">6</a>-->
                <a href="#step-3" type="button" class="btn btn-default btn-circle" data-placement="top" title="Reason for Request" disabled="disabled">6</a>
                <!--                <p><small>Reason for Request</small></p>-->
            </div>
            <div class="stepwizard-step col-xs-3">
                <a href="#step-4" type="button" class="btn btn-default btn-circle" data-placement="top" title="Declaration of Criminal Record" disabled="disabled">7</a>
                <!--                <p><small>Declaration of Criminal Record</small></p>-->
            </div>

            <div class="stepwizard-step col-xs-3">
                <a href="#step-5" type="button" class="btn btn-default btn-circle" data-placement="top" title="Signature" disabled="disabled">8</a>
                <!--                <p><small>Declaration of Criminal Record</small></p>-->
            </div>

            <div class="stepwizard-step col-xs-3">
                <a href="#step-5" type="button" class="btn btn-default btn-circle" disabled="disabled">9</a>
                <!--                <p><small>Cargo</small></p>-->
            </div>
        ...
        <div class="panel panel-primary setup-content" id="step-5">
            ...
            <div class="panel-body gray_background">
                ...
                <a href="<?php echo base_url('user/record_suspension_signature');  ?>">
                    <button class="btn btn-primary nextBtn pull-right next_button_custom_css" type="button">Next</button>
                </a>
            </div>
        </div>
