...
<div class="container">
    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step col-xs-3" data-toggle="tooltip">
                <a href="#step-2" type="button" class="btn btn-default btn-circle" disabled="disabled" data-placement="top" disabled="disabled" title="Address">5</a>
    ...
    <form role="form" action="<?php echo base_url('reception/app_name_based_check_consent_save') ?>" method="post">
        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="panel-body gray_background margin-top-adjustment">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="step1" style="">
                                    ...
                                    <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                        ...
                                        <div class="col-md-8 text-center"  style="background:#f5f5f5;">
                                            <h3>Application type: Digital Fingerprinting Application</h3>
                                            <br/>
                                            <h5>Your Application ID is: <strong>200289</strong></h5>
                                            <!--                            <br>-->
                                            <h5>Your Application charges: <strong>....</strong></h5>
                                            <br />
                                    ...
                                    <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                        ...
                                        <div class="col-md-2 text-center"  style="background:#f5f5f5;"></div>

                                        <div class="col-md-4 text-center"  style="background:#f5f5f5;">
                                            <h5>Referred by:</h5>
                                            <select class="form-select form-control">
                                                <option value="">Select Reffered by</option>
                                                <option value="">agent@gmail.com</option>
                                    ...
                                    <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                        ...
                                        <div class="col-md-2"  style="background:#f5f5f5;"></div>

                                        <div class="col-md-4"  style="background:#f5f5f5;">

                                            <h5>Refund Amount: </h5>
                                            No : <input  type="radio" name="refund" value="No" checked>
                                            Yes: <input type="radio" name="refund" value="Yes">
                ...
                <button class="btn btn-danger nextBtn pull-right next_button_custom_css mobile_setting_next_button" type="button">Cancel</button>
            </div>
        </div>
