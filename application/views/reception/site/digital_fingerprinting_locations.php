...
<form action="<?= base_url() ?>agent/application/digital-fingerprinting/canada" method="post">
...
<script>
    $('#states').on('change', function () {
        ...
        $.post('<?= base_url() ?>agent/application/get-city-by-state',
                {state_id: state_id},
                function (data) {
                    $('#cities').html(data);
                });
    ...
    $('#cities').on('change', function () {
        ...
        $.post('<?= base_url() ?>agent/get-agent-locations',
