...
<!--    --><?php //var_dump($application); ?>
    ...
    <form role="form" action="<?php echo base_url('reception/update_edit_digital_fingerprint_form_save') ?>" method="post">
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <select name="series_type" class="form-control" required="">
                                ...
                                <option value="F" <?php if ($application->series_type == "F") echo "selected='selected'";?>>F</option>
                                <option value="CF" <?php if ($application->series_type == "CF") echo "selected='selected'";?>>CF</option>
                                <option value="N" <?php if ($application->series_type == "N") echo "selected='selected'";?>>N</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input required="" type="text" value="<?= $application->consent_first_name ?>" name="consent_first_name" class="form-control"/>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label class="control-label">  Middle Name: </label>
                            <input type="text" value="<?= $application->consent_middle_name ?>" name="consent_middle_name" class="form-control"/>
                        </div>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" required value="<?= $application->consent_last_name ?>" name="consent_last_name" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="consent_maiden_name" value="<?= $application->consent_maiden_name ?>" class="form-control input"/>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label class="control-label">  Date of Birth: (YYYY/MM/DD) </label>
                            <input required="" type="text" name="consent_dob" value="<?= $application->consent_dob ?>" class="form-control"/>
                        </div>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="consent_place_of_birth" value="<?php echo $application->consent_place_of_birth; ?>" class="form-control input"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input required="" type="text" name="consent_current_address" value="<?= $application->consent_current_address ?>" class="form-control input"/>
                        </div>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="consent_email" required value="<?= $application->consent_email ?>" class="form-control input"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label> Tell: </label>
                            <input type="text" name="consent_phone" value="<?= $application->consent_phone ?>" class="form-control input"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input required="" type="text" name="consent_cellphone" value="<?= $application->consent_cellphone ?>" class="form-control input"/>
                        </div>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input required="" type="text" name="consent_gender" value="<?= $application->gender ?>" class="form-control input"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="consent_hair_color" value="<?= $application->hair_color ?>" class="form-control input"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="consent_eye_color" value="<?= $application->eye_color ?>" class="form-control input"/>
                        </div>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="consent_height" value="<?= $application->height ?>" class="form-control input"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="consent_weight" value="<?= $application->weight ?>" class="form-control input"/>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body gray_background">
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-top">
                        <input type="checkbox" value="1" name="federal_employment" <?php echo ($application->federal_employment ==1 ? 'checked' : '');?>>
                        <label>Federal Employment :</label>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Employer Name: : </label>
                        <input type="text" name="federal_employer_name" value="<?= $application->federal_employer_name ?>" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Job Title:  </label>
                        <input type="text" name="federal_job_title" value="<?= $application->federal_job_title ?>" class="form-control input"/>
                    </div>
                </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-top">
                        ...
                        <input type="checkbox" value="1" name="provincial_employment" <?php echo ($application->provincial_employment ==1 ? 'checked' : '');?>>
                        <label>Provincial Employment :</label>

                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Employer Name: </label>
                        <input type="text" name="provincial_employer_name" value="<?= $application->provincial_employer_name ?>" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Job Title:  </label>
                        <input type="text" name="provincial_job_title" value="<?= $application->provincial_employer_title ?>" class="form-control input"/>
                    </div>
                </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-top">
                        <input type="checkbox" name="private_industry" value="1" <?php echo ($application->private_industry ==1 ? 'checked' : '');?>>
                        <label>Private Industry :</label>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Company Name: </label>
                        <input  type="text" name="private_industry_company_name" value="<?= $application->private_industry_company_name ?>" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Position:  </label>
                        <input type="text" name="private_industry_position" value="<?= $application->private_industry_position ?>" class="form-control input"/>
                    </div>
                </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-top">
                        ...
                        <input type="checkbox" name="citizenship" value="1" <?php echo ($application->Citizenship ==1 ? 'checked' : '');?>>
                        <label>Citizenship :</label>

                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  IRCC File No : </label>
                        <input  type="text" name="citizenship_ircc_file_no" value="<?= $application->citizenship_ircc_file_no ?>" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  UCI:  </label>
                        <input type="text" name="citizenship_uci" value="<?= $application->citizenship_uci ?>" class="form-control input"/>
                    </div>
                </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-top">
                        <input type="checkbox" value="1" name="permanent_residency" <?php echo ($application->permanent_residency ==1 ? 'checked' : '');?>>
                        <label>Permanent Residency :</label>
                    </div>

                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  IRCC File No : </label>
                        <input type="text" name="permanent_residency_ircc_file_no" value="<?= $application->permanent_residency_ircc_no ?>" class="form-control input"/>
                    </div>

                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  UCI:  </label>
                        <input type="text" name="permanent_residency_uci" value="<?= $application->permanent_residency_uci ?>" class="form-control input"/>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" <?php echo ($application->vulnerable_sector ==1 ? 'checked' : '');?> value="1" name="vulnerable_sector"/>
                        <label>  Vulnerable Sector  </label>

                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" <?php echo ($application->volunteer_work ==1 ? 'checked' : '');?>  value="1" name="volunteer_work"/>
                        <label>  Volunteer Work  </label>

                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" <?php echo ($application->adoption ==1 ? 'checked' : '');?> value="1" name="adoption"/>
                        <label>  Adoption  </label>

                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" <?php echo ($application->fbi ==1 ? 'checked' : '');?> value="1" name="fbi"/>
                        <label>  FBI  </label>
                    </div>

                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" <?php echo ($application->international_fingerprints ==1 ? 'checked' : '');?> value="1" name="international_fingerprints"/>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" value="1" name="record_suspension" <?php echo ($application->record_suspension ==1 ? 'checked' : '');?>>
                        <label>Record Suspension</label>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" name="us_entry_waiver_travel_visa" value="1" <?php echo ($application->us_entry_waiver_travel_visa ==1 ? 'checked' : '');?>/>
                        <label>  U.S. Entry Waiver/Travel/Visa</label>

                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" value="1" name="name_change" <?php echo ($application->name_change ==1 ? 'checked' : '');?>/>
                        <label>  Name Change </label>

                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <input type="checkbox" value="1" name="other" <?php echo ($application->other ==1 ? 'checked' : '');?>/>
                        <label>  Other  </label>
                        <input style="width: 80%; float: right; margin-top: -5px;" type="text" name="other_text" value="<?= $application->other_text ?>" class="form-control"/>
        ...
        <div class="panel panel-primary setup-content" id="step-4">
            ...
            <div class="panel-body gray_background">
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" required name="officer_name" value="<?= $application->officer_name ?>" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" required name="date_fingerprinted" value="<?= $application->date_fingerprinted ?>" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" required name="time_fingerprinted" value="<?= $application->time_fingerprinted ?>" class="form-control"/>
                        </div>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" required name="date_submitted" value="<?= $application->date_submitted ?>" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="result_deliver">
                                ...
                                <option value="Individual" <?php if ($application->result_delivery == "Individual") echo "selected='selected'";?>>Individual</option>
                                <option value="Contributor" <?php if ($application->result_delivery == "Contributor") echo "selected='selected'";?>>Contributor</option>
                                <option value="Response Address" <?php if ($application->result_delivery == "Response Address") echo "selected='selected'";?>>Response Address</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="rcmp_status">
                                ...
                                <option value="Cleared" <?php if ($application->rcmp_status == "Cleared") echo "selected='selected'";?>>Cleared</option>
                                <option value="Error" <?php if ($application->rcmp_status == "Error") echo "selected='selected'";?>>Error</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="dcb_number" value="<?= $application->dcb_number ?>" class="form-control input"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="referred_by" value="<?= $application->referred_by ?>" class="form-control input"/>
                            <input type="hidden" name="digital_fingerprinting_application_id" value="<?= $application->digital_fingerprinting_application_id ?>"  class="form-control input"/>
                        </div>
                    </div>
                </div>
                ...
                <button class="btn btn-primary pull-right next_button_custom_css mobile_setting_next_button" type="submit">Update</button>
            </div>
        </div>
