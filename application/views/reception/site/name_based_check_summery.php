                                ...
                                <div class="tab-pane fade in active" id="step1" style="">
                                    ...
                                    <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                        ...
                                        <div class="col-md-8 text-center"  style="background:#f5f5f5;">
                                            <h3>Application type: Name Based Application.</h3>
                                            <br/>
                                            <h5>Your Application ID is: <strong>100289</strong></h5>
                                            <!--                            <br>-->
...
<!--                                        <div class="col-md-2 text-center"  style="background:#f5f5f5;"> </div>-->
                ...
                <button class="btn btn-danger nextBtn pull-right next_button_custom_css mobile_setting_next_button" type="button">Terminate</button>
            </div>
        </div>
