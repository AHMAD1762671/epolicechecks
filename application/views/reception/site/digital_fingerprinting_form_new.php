...
<!--            </div>-->
    ...
    <form role="form" action="<?php echo base_url('reception/app_digital_fingerprinting_form_save'); ?>" method="post">
...
<!--                                <h6 style="margin-top: 150px;">   Digital Fingerprints</h6>-->
                                <h3 style="text-align: center;">  Live Scan</h3>
                                <br/>
...
<!--                                <img src="--><?//= base_url('site-assets') ?><!--/images/2.png" class="mb-2 " style="height: 139px; width: 123px; margin-top: 100px; float: left; ">-->
                            ...
                            <div class="col-sm-7">
                                <p>
                                    <input type="checkbox" name="digital_fingerprinting_options" value="">    Canadian Citizenship  <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Canada Permanent Residency   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Travel/Visa/Border Crossing/Work   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Pardon / Record Suspension   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Adoption   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Employment – Private Industry   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Employment – Provincial Government   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Employment – Federal Government   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Employment – Volunteer   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Employment – Police    <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Employment – Other : ____________   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Name Change   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Privacy Act Request   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	Other – Specify Reason: ____________   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value=""> 	FBI   <br>
                                    <input type="checkbox" name="digital_fingerprinting_options" value="">	Fingerprint Card Only   <br>
                                </p>
<!--                                    --><?php //foreach ($options as $value) { ?>
<!--                                        <input type="checkbox" name="digital_fingerprinting_options[]" value="--><?php //$value->digital_fingerprinting_option ?><!--">  -->
<!--                                    --><?php //$value->digital_fingerprinting_option ?><!-- <br>-->
<!--                                    --><?php //} ?>
<!--                                </php>-->
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" style="margin-top: 30px;">
                        <div class="row" style="margin-bottom:5px;">
                            ...
                            <div class="col-6">
                                <select class="form-control" id="states" name="agency_state">
            ...
            <div class="panel-body gray_background">
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
                        ...
                        <input type="text" name="consent_maiden_name" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Date of Birth: (YYYY/MM/DD) </label>
                        <input required="" type="text" name="consent_dob" class="form-control input"/>
                    </div>
                </div>
                <br/>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label> Tell: </label>
                        <input type="text" name="consent_tel" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Cell: </label>
                        <input required="" type="text" name="consent_cell" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>  Email:  </label>
                        <input type="text" name="consent_email" class="form-control input"/>
                    </div>
                </div>
                <br/>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <input required="" type="text" name="fingerprinting_agency_address" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <label>  Fingerprinting Agency Tel: </label>
                        <input required="" type="text" name="fingerprinting_agency_tel" class="form-control input"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <label> RCMP Application Type: </label>
                        <input required="" type="text" name="rcmp_application_type" class="form-control input"/>
                    </div>
                ...
                <div class="row" style="padding-left: 15px; padding-right: 15px; margin-right: 15px; margin-left: 15px;">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <input required="" type="text" name="send_result_to" class="form-control input"/>
                    </div>
                </div>
                <br/>

                <button class="btn btn-primary nextBtn pull-right next_button_custom_css mobile_setting_next_button" type="submit">Submit</button>
            </div>
        </div>
