                ...
                <a href="<?php echo base_url('reception/app_record_suspension'); ?>">
                    <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, 	rgb(0, 128, 0) 0, #00FF00 100%);box-shadow: 0 2px 10px rgb(234 33 103 / 30%);">
                        <div class="card-body pb-0">
                            ...
                            <p style="font-size: 15px; text-align: center;" class=" mb-1 "><b>Application (ticket)</b></p>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                foreach ($applications as $key => $value) {
                    ...
                    <tr>
<!--                        <th class="align-middle text-center">--><?php //echo $key['digital_fingerprinting_application_id']; ?><!--</th>-->
                        ...
                        <th class="align-middle text-center"><?= $value->application_status ?> </th>
                        <th class="align-middle text-center"><?= $value->created_at ?></th>
                        <th class="align-middle text-center">
                            <a href="<?php echo base_url('reception/record_suspension_application_download/').$value->record_suspension_id; ?>" target="_blank" class="btn btn-primary" title="Download Application">
                                <span class="fa fa-download"></span>
                            </a>
                            <a href="<?php echo base_url('reception/record_suspension_application_details/').$value->record_suspension_id; ?>" target="_blank" class="btn btn-primary"  title="View Application">
                                    <span class="fa fa-eye"></span>
  
                            </a>
                            <!-- <a href="#" class="btn btn-primary" title="View Application">
                                <span class="fa fa-eye"></span>
                            </a> -->

                            <a href="#" class="btn btn-danger" title="Finish Application">
