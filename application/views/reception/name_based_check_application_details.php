<div class="tab-content" id="profileTabContent">
    <div class="tab-pane fade active show">
        <div class="row text-center">
            <div class="col-6">
                <h4 class="text-theme"><strong>Application ID: </strong><?= $application->name_based_application_id ?></h4>
            </div>
            <div class="col-6">
        ...
        <div class="row">
            ...
            <div class="mb-4 col-md-4 col-lg-3 col-sm-6">
                ...
                <span class="pr-5"><?= get_delivery_method_name_by_id($application->delivery_method_id) ?></span> <span><strong><?= $application->delivery_method_price ?> CAD</strong></span>
            </div>
        </div>
        <hr>
        ...
        <h4 class="text-theme"><span class="fa fa-user text-16 mr-1"></span> Submitted By</h4>
        <div class="row">
            <div class="mb-4 col-md-4 col-lg-3 col-sm-6">
                <span><?= $application->reception_id ?></span>
            </div>
        </div>
