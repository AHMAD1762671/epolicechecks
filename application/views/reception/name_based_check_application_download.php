...
<!--    <img style="width: 150px; padding-left: 20px; float: left;" src="http://localhost/epolicechecks/assets/images/logo.png" alt="">-->
    ...
    <div class="tab-pane fade active show">
        ...
        <h4 class="text-theme" style="font-size: 10px; margin-top: -20px;"><span class="fa fa-support text-16 mr-1"></span> PERSONAL INFORMATION </h4>
    ...
    <div class="tab-pane fade active show"  style="margin-top: -20px;">
    ...
    <h5 class="text-theme" style="font-size: 10px; margin-top: -20px;"><span class="fa fa-support text-16 mr-1"></span> REASON FOR REQUEST: <?= $application->consent_reason ?> </h5>
    ...
    <div class="tab-pane fade active show" style="margin-top: -10px;">
