                ...
                <div class="header-part-right">
                    ...
                    <div class="dropdown">
                        <div class="user colalign-self-end">
                            <img src="<?php echo base_url($this->session->userdata('reception_profile_image')) ?>" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="<?= base_url('reception/edit_reception_profile') ?>">Account settings</a>
            ...
            <div class="side-content-wrap">
                <div class="sidebar-left open" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                    <ul class="navigation-left">
                        ...
                        <li class="nav-item <?= active_menu('reception/edit_reception_profile') ?>">
                            <a class="nav-item-hold" href="<?= base_url('reception/edit_reception_profile') ?>">
