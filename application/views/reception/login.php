    ...
    <style>
        @media only screen and (min-width: 850px) and (max-width: 1024px)  {
            .forny-container {
                ...
                /*                background: url(*/<?php //echo base_url().'/assets/images/business-deal-ipadPro.jpg'; ?>/*)  center center no-repeat;*/
                background: url(<?php echo base_url().'/assets/images/login.png'; ?>)  center center no-repeat;
    ...
    <div class="forny-inner">
        ...
        <div class="forny-form">
            ...
            <div class="mb-6 text-center forny-logo">
                <img height="100" width="150" src="<?php echo base_url(); ?>assets/images/logox.png">
            </div>
            ...
            <form method="post" action="<?= base_url('reception/signin') ?>">
...
<!--                        </div>-->
                    ...
                    <div class="col-6 text-right">
                        <a href="<?= base_url('portal/forgot-password') ?>">Forgot password?</a>
                    </div>
                </div>
