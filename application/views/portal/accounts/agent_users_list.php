        ...
        <div class="table-responsive">
            <table class="display table table-bordered">
                ...
                foreach ($user_list as $key => $value) {
                    ?>
                    <tr>
                        <th class="align-middle"><a href="<?php echo base_url('portal/get_agent_users_list_accounts/').$value->id; ?>"> <?= $value->id ?> </a> </th>
                        ...
                        <td class="align-middle">
                            <a href="<?php echo base_url('portal/action_agent') ?>">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-group mb-3">
                                                    ...
                                                    <input name="remaining_payment" value="80" class="form-control" required="" readonly>
                                                </div>
