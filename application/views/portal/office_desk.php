...
<div class="row">
    <div class="col-md-12 col-lg-12">
                    ...
                    foreach ($office_desk as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <a class="btn btn-primary" href="<?= base_url() ?>portal/download-office-desk-document/<?= $value->office_desk_id ?>" title="Download Document">
                    ...
                    <div class="modal fade" id="office_desk_<?= $value->office_desk_id ?>" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="<?= base_url('portal/edit-office-desk') ?>" method="post">
        ...
        <div class="modal fade" id="add_office_desk" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="<?= base_url('portal/add-office-desk') ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
    ...
    $(document).ready(function () {
        $('.delete-office-desk').click(function () {
            ...
            swal({
                ...
                $.post('<?= base_url() ?>portal/delete-office-desk',
