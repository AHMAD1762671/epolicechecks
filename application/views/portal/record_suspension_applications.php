            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #4a85fb 0, #163eaf 100%); box-shadow: 0 2px 10px rgb(22 62 175 / 30%);}">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $recordTotalNew ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #fc7a5a 0, #d72e04 100%); box-shadow: 0 2px 10px rgb(215 46 4 / 30%);}">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $recordTotalUnderProcess ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #60c3b6 0, #269f90 100%);box-shadow: 0 2px 10px rgb(38 159 144 / 30%);">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $recordTotalPendingDocuments ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #fb6ba7 0, #ea2167 100%);box-shadow: 0 2px 10px rgb(234 33 103 / 30%);">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $recordTotalCompelted ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, rgb(255, 179, 94) 0, #c87517 100%);box-shadow: 0 2px 10px rgb(234 33 103 / 30%);">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $recordTotalNotApplied ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
...
<form>
    <div class="row mb-3 ">
        ...
        <div class="col-sm-2 mt-3 mt-md-0">
            <!--            <input type="text" value="--><?//= $dob ?><!--" name="dob" class="form-control" placeholder="Date of Birth">-->
        ...
        <div class="col-sm-1 mt-3 mt-md-0 pl-4">
...
<!--                            <td class="align-middle">--><?php // get_application_submitted_by($value->agent_id, $value->corporate_id) ?><!--</td>-->


                            <?php
                            if($value->application_status == "New"){
                                ?>
                                <td style="color: #13375c;" class="align-middle">
                                    <span class="new">
                            ...
                            <?php
                            if($value->application_status == "Under Process"){
                                ?>
                            ...
                            <td class="align-middle">
                                <?php
                                if (check_route('security-screening/record-suspension/details', 'get')):
                                    ?>
                                    <a target="_blank" href="<?= base_url() ?>portal/security-screening/record-suspension/details/<?= $value->record_suspension_id ?>" class="btn btn-success" title="View Application">
                                ...
                                ?>
                                <?php
                                if (check_route('security-screening/record-suspension/download', 'get')):
                                    ?>
                                    <a target="_blank" href="<?= base_url() ?>portal/security-screening/record-suspension/download/<?= $value->record_suspension_id ?>" class="btn btn-primary" title="Download Application">
                                ...
                                <button style="margin-top: 1px;" class="btn btn-danger" data-toggle="modal" data-target="#forward_application_to_user<?= $value->record_suspension_id ?>" title="Assign Application">
                        ...
                        <!--    forward_application_to_user -->
                        <div class="modal fade" id="forward_application_to_user<?= $value->record_suspension_id ?>" data-backdrop="static" data-keyboard="false">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form action="<?php echo base_url('agent/forward_Record_Suspension_application_to_user') ?>" method="post">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Assign Application /<?= $value->record_suspension_id ?> </h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <?php
                                                $comment_pic= get_user_roles_by_id($value->record_suspension_id );
                                                ?>
                                                ...
                                                <input type="hidden" class="form-control" required="" name="record_suspension_id" value="<?= $value->record_suspension_id ?>">
                                            </div>
                                        </div>
