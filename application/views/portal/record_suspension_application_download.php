...
<h2 style="text-align: center; color: #FF0000; font-size: 16px; text-decoration: underline;">  Record Suspension Application </h2>
...
<div class="tab-content" id="profileTabContent">
    ...
    <div style="border: solid 0.5px #000000; padding: 10px">
            <span style="font-size: 9px;">Do you have  a criminal record or ever been arrested in Canada?</span>  <br>
            <span style="font-size: 10px;"><b>No</b> <br>
            <span style="font-size: 9px;">Do you have a criminal record or ever been arrested in United States of America?</span> <br>
                <span style="font-size: 10px;"> <b>No</b>   <br>
            <span style="font-size: 9px;">Do you have  a criminal record or ever been arrested in a Foreign Country?</span> <br>
                    <span style="font-size: 10px;"><b>No</b>  <br>
            <span style="font-size: 9px;">Have you ever been refused entry at the USA port of entry/USA border?</span>  <br>
                        <span style="font-size: 10px;"><b>No</b>  <br>
            <span style="font-size: 9px;">Have you ever been refused entry at the USA port of entry/USA border?</span>  <br>
                            <span style="font-size: 10px;"><b>No</b>  <br>
            <span style="font-size: 9px;">Have you ever received a fine for your criminal charges in Canada, USA or foreign country?</span> <br>
                                <span style="font-size: 10px;"><b>No</b>  <br>
            <span style="font-size: 9px;">Have you ever been convicted of a criminal offence for which a pardon has not been granted?</span>  <br>
                                    <span style="font-size: 10px;"><b>No</b>  <br>
...
<!--        </span>-->
    ...
    <h5 style="text-align: center; color: #FF0000; text-decoration: underline; font-size: 11px;"> TERMS AND CONDITIONS </h5>
    <br>
    ...
    <table class="table">
        ...
        <tr>
            <td>
                ...
                <img height="50px" width="100px"  src="<?php echo base_url().'upload/applicant_signatures/'.$application->consent_signature_drawable ?>">
                <?php } ?>
