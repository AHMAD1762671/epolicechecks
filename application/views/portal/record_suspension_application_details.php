<div class="tab-content" id="profileTabContent">
    <div class="tab-pane fade active show">
        <div class="row text-center">
            <div class="col-6">
                <h4 class="text-theme"><strong>Client ID: </strong><?= $application->record_suspension_id ?></h4>
            </div>
            <div class="col-6">
...
<div class="row">
    <div class="col-lg-5" id="status">
        ...
        <div class="pl-5 mb-4">
            ...
            <input type="hidden" name="type" id="type" value="record-suspension">
        ...
        <div class="button-box col-lg-12">
            ...
            <form class="" action="<?= base_url() ?>portal/multiple_file_upload" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="hidden" name="type" value="record-suspension">
    ...
    <div class="col-lg-3" style="border-left: 1px solid rgba(0, 0, 0, .1);">
        ...
        <form class="pl-5 mb-4" action="<?= base_url() ?>portal/add_application_status_save_record_suspension_application" method="post">
