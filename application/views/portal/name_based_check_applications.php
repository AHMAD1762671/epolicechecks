                    ...
                    foreach ($applications as $key => $value) {
                        ...
                        <tr <?php if($value->new_application == 1){ ?>style="background-color: rgba(0, 0, 0, .075);" <?php } ?>>
                            <th class="align-middle">
                                ...
                                <?=  date("Y")."-SS-". $value->name_based_application_id ?>
                            </th>
                        ...
                        ?>
                            ...
                            <td class="align-middle">
                                ...
                                ?>
                                <?php
                                if (check_route('security-screening/name-based-check/download', 'get')):
                                    ?>
                                    <a target="_blank" href="<?= base_url() ?>portal/security-screening/name-based-check/download/<?= $value->name_based_application_id ?>" class="btn btn-primary" title="Download Application">
