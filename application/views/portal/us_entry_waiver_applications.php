            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #4a85fb 0, #163eaf 100%); box-shadow: 0 2px 10px rgb(22 62 175 / 30%);}">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $usTotalNew ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #fc7a5a 0, #d72e04 100%); box-shadow: 0 2px 10px rgb(215 46 4 / 30%);}">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $usTotalUnderProcess ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #60c3b6 0, #269f90 100%);box-shadow: 0 2px 10px rgb(38 159 144 / 30%);">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $usTotalPendingDocuments ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #fb6ba7 0, #ea2167 100%);box-shadow: 0 2px 10px rgb(234 33 103 / 30%);">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $usTotalCompelted ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, rgb(255, 179, 94) 0, #c87517 100%);box-shadow: 0 2px 10px rgb(234 33 103 / 30%);">
                    <div class="card-body pb-0">
                        ...
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $usTotalNotApplied ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
                    ...
                    foreach ($applications as $key => $value) {
                        ...
                        <tr>
                            ...
                            if($value->application_status == "Completed"){
                                ?>
                                <td style="color: #301934;" class="align-middle">
                            ...
                            <td class="align-middle">
                                <?php
                                if (check_route('security-screening/us-entry-waiver/details', 'get')):
                                    ?>
                                    <a target="_blank" href="<?= base_url() ?>portal/security-screening/us-entry-waiver/details/<?= $value->us_entry_waiver_id ?>" class="btn btn-success" title="View Application">
                                ...
                                ?>
                                <?php
                                if (check_route('security-screening/us-entry-waiver/download', 'get')):
                                    ?>
                                    <a target="_blank" href="<?= base_url() ?>portal/security-screening/us-entry-waiver/download/<?= $value->us_entry_waiver_id ?>" class="btn btn-primary" title="Download Application">
                                ...
                                <button style="margin-top: 1px;" class="btn btn-danger" data-toggle="modal" data-target="#forward_application_to_user<?= $value->us_entry_waiver_id ?>" title="Assign Application">
                                    <span class="fas fa-forward"></span>
                                </button>

                                <!--    forward_application_to_user -->
                                <!--    forward_application_to_user -->
                                <div class="modal fade" id="forward_application_to_user<?= $value->us_entry_waiver_id ?>" data-backdrop="static" data-keyboard="false">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <form action="<?php echo base_url('portal/forward_us_entry_waiver_application_to_user') ?>" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <?php
                                                        $comment_pic= get_user_roles_by_id($value->us_entry_waiver_id);
                                                        ?>
                                                        ...
                                                        <input type="hidden" class="form-control" required="" name="us_entry_waiver_application_id" value="<?= $value->us_entry_waiver_id ?>">
                                                    </div>
                                                </div>
