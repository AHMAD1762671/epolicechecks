    ...
    <div class="tab-pane fade active show">
        ...
        <div class="row">
            <div class="mb-4 col-md-4 col-lg-3 col-sm-6">
                ...
                <span><?= $application->agency_address ?></span>
            </div>
            <div class="mb-4 col-md-4 col-lg-3 col-sm-6">
                <h5 class="mb-1 text-theme">City</h5>    
                <span><?= get_city_name_by_id($application->agency_city) ?></span>
            </div>
            <div class="mb-4 col-md-4 col-lg-3 col-sm-6">
                <h5 class="mb-1 text-theme">State</h5>    
                <span><?= get_state_name_by_id($application->agency_state) ?></span>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <div class="mb-4 col-md-4 col-lg-3 col-sm-6">
                ...
                <span><?= $application->consent_signature ?></span>
            </div>
            <div class="mb-4 col-md-4 col-lg-3 col-sm-6">
                <h5 class="mb-1 text-theme">Date</h5>
                <span><?= $application->consent_date ?></span>
            </div>
        </div>
        <hr>
...
<div class="row">
    <div class="col-lg-5" id="status">
        ...
        <div class="pl-5 mb-4">
            ...
            <input type="hidden" name="type" id="type" value="digital-fingerprinting">
        ...
        <div class="button-box col-lg-12">
            ...
            <form class="" action="<?= base_url() ?>portal/multiple_file_upload" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="hidden" name="type" value="digital-fingerprinting">
    ...
    <div class="col-lg-3" style="border-left: 1px solid rgba(0, 0, 0, .1);">
        ...
        <form class="pl-5 mb-4" action="<?= base_url() ?>portal/add_application_status_save_digital_fingerprinting_application" method="post">
