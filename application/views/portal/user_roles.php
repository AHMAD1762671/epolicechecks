...
<div class="row">
    <div class="col-md-12 col-lg-12">
                    ...
                    foreach ($user_roles as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <a class="btn btn-primary" href="<?= base_url() . 'portal/user-roles-permissions/' . $value->user_role_id ?>" title="Assign User Role's Permission">
                    ...
                    <div class="modal fade" id="user_roles_<?= $value->user_role_id ?>" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="<?= base_url('portal/edit-user-role') ?>" method="post">
        ...
        <div class="modal fade" id="add_user_roles" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="<?= base_url('portal/add-user-role') ?>" method="post">
                        <div class="modal-header">
    ...
    $(document).ready(function () {
        $('.delete-user_roles').click(function () {
            ...
            swal({
                ...
                $.post('<?= base_url() ?>portal/delete-user-role',
