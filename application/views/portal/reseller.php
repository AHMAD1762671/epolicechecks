<!--style for on off button in botoom of the form-->
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card bg-gradient-info overflow-hidden text-white" style="background-image: linear-gradient(to bottom, #4a85fb 0, #163eaf 100%); box-shadow: 0 2px 10px rgb(22 62 175 / 30%);}">
                    <div class="card-body pb-0">
                        <p style="font-size: 15px; text-align: center;" class=" mb-1 "><b>  Resellers </b></p>
                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b><?= $reseller; ?></b></p>
                    </div>
                    <br>
                </div>
            </div>
...
<div class="row">
    ...
    <div class="col-xl-9 col-lg-6 col-md-4">
        <button class="btn btn-primary" data-toggle="modal" data-target="#add_user">Add reseller</button>
    </div>
</div>
<br>
...
<div class="row">
    <div class="col-md-12 col-lg-12">
        ...
        <div class="modal fade" id="add_user" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="<?= base_url('portal/add_reseller_save') ?>" method="post">
                        <div class="modal-header">
...
<!--                                </script>-->
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <h4 style="padding-right: 15px; padding-left: 15px;">Application Comission</h4>
