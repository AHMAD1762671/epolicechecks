...
<!--                        <p style="font-size: 20px; text-align: center;" class=" mb-1 "><b>240 CAD</b></p>-->
<!--                    </div>-->
<!--                    <br>-->
<!--                </div>-->
<!--            </div>-->
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th class="align-middle" scope="col">Total Paid</th>
                    <th class="align-middle" scope="col">Total Comission</th>
                    <th class="align-middle" scope="col">Created At</th>
<!--                    <th class="align-middle" scope="col">Created By</th>-->
                </tr>
                </thead>
                <tbody>
                <?php
