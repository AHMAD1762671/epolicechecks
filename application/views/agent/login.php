...
<!--                <img height="40" width="150" src="http://localhost/epolicechecks/assets/images/logo-epolice.png">-->
...
<!--                <p class="mb-10">Use your credentials to access your account.</p>-->
            ...
            <form method="post" action="<?= base_url('agent/signin') ?>">
                ...
                <div class="row mt-6 mb-6">
                    ...
                    <div class="col-6 text-right">
                        <a href="<?= base_url('agent/forgot-password') ?>">Forgot password?</a>
                    </div>
                </div>
