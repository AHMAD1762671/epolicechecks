    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step col-xs-3" data-toggle="tooltip">
                <a href="#step-2" type="button" class="btn btn-default btn-circle"  data-placement="top"  title="Address" disabled="disabled">2</a>
                <!--                <p><small>Address</small></p>-->
            </div>
            <div class="stepwizard-step col-xs-3">
                <!--                <a href="#step-3" type="button" class="btn btn-default btn-circle" disabled="disabled" title="Reason for Request">6</a>-->
                <a href="#step-3" type="button" class="btn btn-default btn-circle" data-placement="top" title="Reason for Request" disabled="disabled">3</a>
                <!--                <p><small>Reason for Request</small></p>-->
            </div>
            <div class="stepwizard-step col-xs-3">
                <a href="#step-4" type="button" class="btn btn-default btn-circle" data-placement="top" title="Declaration of Criminal Record" disabled="disabled">4</a>
                <!--                <p><small>Declaration of Criminal Record</small></p>-->
            </div>

            <div class="stepwizard-step col-xs-3">
                <a href="#step-5" type="button" class="btn btn-default btn-circle" data-placement="top" title="Signature" disabled="disabled">5</a>
                <!--                <p><small>Declaration of Criminal Record</small></p>-->
            </div>
...
<!--            </div>-->
    ...
    <form role="form" method="post" action="<?php echo base_url('reception/app_record_suspension_consent_save'); ?>">
        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped bg-success active" role="progressbar" style="width: 16%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
        ...
        <div class="panel panel-primary setup-content" id="step-2">
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped bg-success active" role="progressbar" style="width: 32%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
        ...
        <div class="panel panel-primary setup-content" id="step-3">
            <div class="progress">
                <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 48%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
        ...
        <div class="panel panel-primary setup-content" id="step-4">
            <div class="progress">
                <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 64%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
...
<!--                <a href="--><?php //echo base_url('user/record_suspension_signature');  ?><!--">-->
                    <button class="btn btn-primary nextBtn pull-right next_button_custom_css" type="submit" name="submit">Submit</button>
<!--                </a>-->
            </div>
        </div>
