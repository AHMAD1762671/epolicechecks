...
<body>
    ...
    <section style="background:#efefe9;">
        <div class="container">
            <form action="<?= base_url() ?>agent/application/record-suspension/consent" method="post">
                <div class="row">
                    <div class="board">
                            ...
                            <div class="tab-pane fade" id="final">
                                ...
                                <div class="row" style="margin-bottom: 15px; margin-right: 5px;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="right">
                                        ...
                                        <button type="submit" class="btn btn-success" id="submit-button" name="submit">Submit</button>
                                    </div>
                                </div>
                            </div>
