...
<div class="wrapper wizard d-flex clearfix multisteps-form position-relative">
    ...
    <form class="multisteps-form__form w-75 order-1" action="<?= base_url() ?>agent/application/name-based-check/consent" method="post" id="wizard" enctype="multipart/form-data">
...
<!--                                                                <form id="signatureform" action="--><?php //echo base_url() ?><!--agent/app_name_based_check_consent_save" enctype="multipart/form-data" style="display:none" method="post">-->
...
<!--                                        <form action="--><?php //echo base_url() ?><!--agent/save_name_based_check_picture_signature" method="post" enctype="multipart/form-data">-->
                    ...
                    <div class="actions mt-60">
                        <ul>
                            <li><span class="js-btn-prev" title="BACK"><i class="fa fa-arrow-left"></i> BACK </span></li>
                            <li><button type="button" id="submit-button" title="NEXT">SUBMIT <i class="fa fa-arrow-right"></i></button></li>
